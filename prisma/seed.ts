...
async function main() {
  ...
  if (!email || !password) throw new Error('ADMIN_EMAIL and ADMIN_PASSWORD are required to seed')
  ...
  // MAIN ADMIN is singular and controlled by the environment-backed seed.
